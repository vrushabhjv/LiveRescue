"""
Django settings for LiveRescue project.
...
SECRET_KEY = 'django-insecure-j80w7@+p*)fe3u43c5zr!9khf-9*cv9^b73q7t0x3p3$3v$k24'
...
WSGI_APPLICATION = 'LiveRescue.wsgi.application'
ASGI_APPLICATION = 'LiveRescue.asgi.application'
